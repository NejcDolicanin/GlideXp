...
**
** $Header: /cvsroot/glide/glide3x/h5/glide3/src/g3df.c,v 1.3 2000/11/15 23:32:53 joseph Exp $
** $Log: 
...
#ifdef GLIDE2
  TO_GLIDE2_LOD(Info->header.small_lod);
  TO_GLIDE2_LOD(Info->header.large_lod);
  TO_GLIDE2_ASPECT(Info->header.aspect_ratio);
#endif
...
#ifdef GLIDE2
  TO_GLIDE3_LOD(info->header.small_lod);
  TO_GLIDE3_LOD(info->header.large_lod);
  TO_GLIDE3_ASPECT(info->header.aspect_ratio);
#endif
