...
**
** $Header: /cvsroot/glide/glide3x/h5/glide3/src/gaa.c,v 1.3 2000/11/15 23:32:53 joseph Exp $
** $Log: 
...
GR_ENTRY(grAADrawPoint, void ,( const GrVertex *pt )) 
{
...
GR_ENTRY(grAADrawPolygon, void ,( int nVerts, const int ilist[], GrVertex vlist[] )) 
{
	grEnable(GR_AA_ORDERED); 
	grDisable(GR_AA_ORDERED); 
}

GR_ENTRY(grAADrawPolygonVertexList, void ,( int nVerts, GrVertex vlist[] )) 
{
	grEnable(GR_AA_ORDERED); 
