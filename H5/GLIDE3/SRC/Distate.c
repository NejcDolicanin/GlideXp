 ...
 **
 **
 ** $Header: /cvsroot/glide/glide3x/h5/glide3/src/distate.c,v 1.4 2000/11/24 18:36:47 alanh Exp $
 ** $Log: 
...
#define FN_NAME "grEnable"
  ...
  case GR_AA_MULTI_SAMPLE:
    {
	  if (gc->state.grEnableArgs.aaMultisampleDisableCount) gc->state.grEnableArgs.aaMultisampleDisableCount--;
