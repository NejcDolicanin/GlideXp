...
int _os_support(int feature)
{
    ...
    __try
    {
        ...
        case _CPU_FEATURE_3DNOWPLUS:
            __asm {
 			    femms
                PSWAPD mm0, mm0			// executing 3DnowPlus instruction
 			    femms
            }
            break;
        case _CPU_FEATURE_MMXPLUS:
            __asm {
				emms
                PMINSW mm0, mm0         // executing MMXPlus instruction (also SSE too)
				emms
            }
            break;
        }
