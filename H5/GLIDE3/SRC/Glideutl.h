...
**
** $Header: /cvsroot/glide/glide3x/h5/glide3/src/glideutl.h,v 1.3 2000/11/15 23:32:53 joseph Exp $
** $Log: 
...
FX_ENTRY void FX_CALL 
guTexCombineFunction( GrChipID_t tmu, GrTextureCombineFnc_t fnc );


// Glide Utils in Glide2
